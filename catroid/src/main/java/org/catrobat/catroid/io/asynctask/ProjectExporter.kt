...
class ProjectExporter(
    ...
    fun exportProjectToExternalStorage() {
        deleteUndoFile(projectDir)
        val projectZip = File(
            Constants.EXTERNAL_STORAGE_ROOT_EXPORT_DIRECTORY,
            projectDir.name + Constants.CATROBAT_EXTENSION
        )
    ...
    private fun deleteUndoFile(projectDir: File) {
    ...
    companion object {
        ...
        private const val PROGRESS_IN_PERCENT = 100
    }
}
